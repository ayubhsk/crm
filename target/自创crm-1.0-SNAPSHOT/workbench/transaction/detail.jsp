...
<%@ page import="com.whx.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.whx.crm.workbench.domain.Tran" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        //更改图标
        function changeIndex(stage, index) {
            var point =<%=point%>//丢失的分界线
            var possibility = $("#possibility").html()
            if (possibility == "0") {//此时当前阶段要是红叉，point前面的都是黑圈
                for (let i = 0; i < point; i++) {//前面都是黑圈
                    //黑圈
                    $("#"+i).removeClass()
                ...
                for (let i = point; i <<%=dvList.size()%>; i++) {//黑叉或者红叉
                    if (i == index) {
                        //红叉
                        $("#"+i).removeClass()
                ...
                for (let i = 0; i < point; i++) {//前半部分绿圈，当前点绿灯，后半部分黑圈
                    if(i<index){
                        //绿勾
                        $("#"+i).removeClass()
                ...
                for (let i = point; i <<%=dvList.size()%>; i++) {//都是黑叉
                    //黑叉
                    $("#"+i).removeClass()
                    $("#"+i).addClass("glyphicon glyphicon-remove mystage")
                    $("#"+i).css("color","#000000")
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
        ...
        if ("0".equals(currentPossibility)) {//此时当前阶段丢失，是红叉
            int index = dvList.size() - 1;//用来标记当前位置的下标
            for (int i = 0; i < dvList.size(); i++) {
    ...
    <%--    <span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom"
        ...
        -------------%>
    <span class="closingDate">${t.createTime}</span>
</div>
...
<div style="position: relative; top: 0px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 50px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${t.activityId}</b></div>
